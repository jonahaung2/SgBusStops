...
final class BusStopsViewModel: ViewModel {
	...
	@ObservationIgnored private var searchPublisher = PassthroughSubject<String, Never>()
	@ObservationIgnored private let cancelBug = CancelBag()
	...
	func performSearch(searchText: String) {
		...
		case .busses:
			if searchText.isEmpty {
				self.routes = busRoutes.sorted { one, two in
